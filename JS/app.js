...
// ----------------------------------------------
 ...
 var user = confirm('Do you want to know alot about me? =)');
//  console.log(user);
 ...
 if(user === true){
  ...
  //  ------------------------------------------------
    ...
    var user = confirm('Mmmm , Do you love Software??');
    // console.log(user);
    ...
    if(user === true){
     ...
     alert('Oops! WHYYYYYYYY =0');
      ...
      //  ------------------------------------------------
       ...
       var user = confirm('Do you know Arab-Bank & Zain-Telecom ??');
      //  console.log(user);
       ...
       if(user === true){
        ...
        alert('Oops! GOOGLE it');
          ...
          var user = confirm('Do you active on social-media?');
          // console.log(user);
          ...
          var user = confirm('Are you bored of my questions? ');
          // console.log(user);
